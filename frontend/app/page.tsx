...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--eth-section-bg)' }}>
      ...
      {/* ── HERO BANNER ──────────────────────────────────────────────── */}
      <section className="relative overflow-hidden pt-16" style={{ background: '#3d2b0e' }}>
        {/* Flag stripe */}
        ...
        {(hero.heroMediaType ?? 'image') === 'video' && hero.heroVideoUrl && (
          <div className="absolute inset-0 overflow-hidden">
            <video
              ...
              playsInline
            />
            <div className="absolute inset-0" style={{ background: 'linear-gradient(105deg, #3d2b0e 0%, #3d2b0eee 40%, #3d2b0e99 60%, transparent 75%)' }} />
          </div>
        )}
        ...
        {!(hero.heroMediaType === 'video' ? hero.heroVideoUrl : hero.heroImageUrl) && (
          <div className="absolute inset-0 pointer-events-none" style={{ background: `linear-gradient(155deg, #3d2b0e 55%, ${ETH_GOLD}22 55%, ${ETH_GOLD}11 100%)` }} />
        )}
      ...
      {/* ── CTA BANNER ───────────────────────────────────────────────── */}
      <section className="relative overflow-hidden" style={{ background: '#1a0f00' }}>
        ...
        <div className="relative">
          ...
          />
          <div className="absolute inset-0" style={{ background: 'linear-gradient(105deg, #1a0f00 50%, transparent 100%)' }} />
